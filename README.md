...
[![Version](https://img.shields.io/badge/version-1.0.0-blue.svg)](https://github.com/sunboostergmbh/ha-sunbooster-powerstation/releases)
...
- **Einfach**: Ein Sunbooster-Key von Ihrem Händler – keine externen Logins nötig
...
2. Repo-URL: `https://github.com/sunboostergmbh/ha-sunbooster-powerstation`
...
1. [Neueste Release-ZIP herunterladen](https://github.com/sunboostergmbh/ha-sunbooster-powerstation/releases/latest)
...
Wenden Sie sich an Ihren Sunbooster-Händler oder an [service@sunbooster.com](mailto:service@sunbooster.com).
...
```
Home Assistant  ──HTTPS──►  api.sunbooster.com  ──API──►  Sunbooster-Cloud  ──►  Powerstation
...
- Keine externen Hersteller-Zugangsdaten beim Kunden

## 🐛 Support

- [Issues auf GitHub](https://github.com/sunboostergmbh/ha-sunbooster-powerstation/issues)
- [service@sunbooster.com](mailto:service@sunbooster.com)
